              ...
              <Space size="middle">
                <div className="d-none d-block-md">
                  <ul className="vurox-horizontal-links vurox-standard-ul pt-2 mb-1">
                    <li>
                      <a href="">
                        <i className="ti-save"></i> save report
                      </a>
                    </li>
                    <li>
                      <a href="">
                        <i className="ti-book"></i> Export to PDF
                      </a>
                    </li>
                    <li>
                      <a href="">
                        <i className="ti-email"></i> Send to email
                      </a>
                    </li>
                  </ul>
                </div>
                <div className="align-right">
                  <button
                    type="button"
                    className="float-none float-sm-right mr-2 btn white bg-magenta-5 btn-md rounded hover-color my-3 my-sm-0 d-block"
                  >
                    Export data <i className="ti-export"></i>
                  </button>
                </div>
              </Space>
            </Col>
          ...
          <Row gutter={{ xs: 4, sm: 6, md: 8 }}>
            ...
            <Col md={18} sm={18}>
              <VuroxMail className="vurox-admin-primary-bg rounded">
                ...
                <h4>{mail.subject}</h4>
                <p>
                  From: {mail.from} <span className="fright">{mail.time}</span>
                </p>
              ...
              <div className="vurox-list-items vurox-admin-primary-bg rounded">
                <ul>
                  <li>
                    <VuroxChatLists
                      chatlink="/823746234"
                      displayPic="/image/propic/1.jpg"
                      name="John Doe"
                      message="Hello ther how are you?I am fine"
                    />
                  </li>
                  <li>
                    <VuroxChatLists
                      chatlink="/82374645234"
                      displayPic="/image/propic/2.jpg"
                      name="Cristiano Doe"
                      message="Hello ther how are you?I am fine"
                    />
                  </li>
