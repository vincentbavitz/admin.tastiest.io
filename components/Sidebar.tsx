...
export default function Sidebar() {
  ...
  return (
    <div
      ...
      className="relative flex flex-col justify-between h-full py-4 duration-300 bg-white border-r-2 border-gray-200"
    >
      <div
        onClick={() => toggleCollapsed()}
        className={clsx(
          'absolute right-0 z-50 flex items-center w-4 h-10',
